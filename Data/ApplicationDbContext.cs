...
namespace BuildingSiteManagementWebApp.Data
{
    public class ApplicationDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                entity.ToTable("HomeTypes").Property(h => h.Name).IsRequired();
                entity.HasIndex(h => h.Name).HasFilter("Name IS NOT NULL").IsUnique();
            });
            builder.Entity<Message>(entity =>
            {
                entity.ToTable("Messages").Property(m => m.Subject).IsRequired();
                ...
                entity.Navigation(m => m.Receiver).AutoInclude();

            });
            builder.Entity<Payment>(entity =>
            {
                entity.ToTable("Payments").Property(p => p.UserId).IsRequired();
            ...
            {
                entity.ToTable("Residents");//.Navigation(r => r.RentedResidences).AutoInclude();
                //entity.Navigation(r => r.OwnedResidences).AutoInclude();
                //entity.Navigation(r => r.Residence).AutoInclude();
            });
